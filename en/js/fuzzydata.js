...
{ "title" : "The Global Resource Plan Overview ", 
"url" : "using-oneplan/resource-plans/the-global-resource-plan-overview.html", 
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ Resource Plans \/ The Global Resource Plan Overview ", 
"snippet" : "This article an overview of the Global Resource Plan. The Global Resource Plan shows all resource allocation across all the plans. This is a useful page for managers to review allocation across multiple plans. If your organization is using the Negotiations feature, the email notifications contain a ...", 
"body" : "This article an overview of the Global Resource Plan. The Global Resource Plan shows all resource allocation across all the plans. This is a useful page for managers to review allocation across multiple plans. If your organization is using the Negotiations feature, the email notifications contain a link to the Resource Plan page, filtered for that plan's resources. You can also navigate to the page directly via the Resource Plan icon on the OnePlan navigation menu. " }, 
{ "title" : "Pre-filters ", 
"url" : "using-oneplan/resource-plans/the-global-resource-plan-overview.html#UUID-00335129-86c4-1cad-6a0f-479ed648a39f_id_360060283111_id_pre-filters", 
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ Resource Plans \/ The Global Resource Plan Overview \/ Pre-filters ", 
...
{ "title" : "Icon Menu ", 
"url" : "using-oneplan/resource-plans/the-global-resource-plan-overview.html#UUID-00335129-86c4-1cad-6a0f-479ed648a39f_id_360060283111_id_icon-menu", 
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ Resource Plans \/ The Global Resource Plan Overview \/ Icon Menu ", 
"snippet" : "Icons listed in order from left to right: Icon Name Description Cost Types Toggle between Resource Plan cost types. Cost Types are configured per business use case. These allow for analysis of how resources are initially planned compared to how they are actually assigned and work. Add Booking Click ...", 
"body" : "Icons listed in order from left to right: Icon Name Description Cost Types Toggle between Resource Plan cost types. Cost Types are configured per business use case. These allow for analysis of how resources are initially planned compared to how they are actually assigned and work. Add Booking Click this icon to launch the booking form. Candidates List Click the icon to toggle showing the Candidates List on the bottom half of the screen. See How do I use the Resource Pane? for more details. Views Planning Units Mode Select Hours, % (Percent), or FTE (Full Time Equivalent). Modify View Menu Settings in this menu include: Dates: Select the desired date range of periods. Note that the \"Totals\" column will calculate based off the date range selected if the planning unit mode is % or FTE. Filter: Select a filters to narrow what shows in the page. Select Clear Filters to remove all filter selections. Group By: Select a field to group the resources by that field. Resource-level choice fields (such as Department and Role) are available for grouping. Compare To: Resource Plan Advanced Menu Options in this menu include: Delegates: Applicable only if the negotiations feature is enabled. The Resource Manager can assign delegates to approve on their behalf, such as their team or department. Legend: Copy Values: " }, 
{ "title" : "Resource Plan Details ", 
"url" : "using-oneplan/resource-plans/the-global-resource-plan-overview.html#UUID-00335129-86c4-1cad-6a0f-479ed648a39f_id_360060283111_id_resource-plan-details", 
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ Resource Plans \/ The Global Resource Plan Overview \/ Resource Plan Details ", 
...
"url" : "using-oneplan/resource-plans/the-global-resource-plan-overview.html#UUID-00335129-86c4-1cad-6a0f-479ed648a39f_id_360060283111_id_resource-plan-details-amp-resource-pane", 
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ Resource Plans \/ The Global Resource Plan Overview \/ Resource Plan Details and Candidates List ", 
...
"url" : "using-oneplan/resource-plans/the-global-resource-plan-overview.html#UUID-00335129-86c4-1cad-6a0f-479ed648a39f_id_360060283111_id_resource-approvals-with-negotiations", 
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ Resource Plans \/ The Global Resource Plan Overview \/ Resource Approvals with Negotiations ", 
"snippet" : "When the Negotiations feature is enabled, the additional status and approval columns show. See How is resource planning done with the Negotiations feature enabled? for more information about the notifications & approvals with negotiations....", 
"body" : "When the Negotiations feature is enabled, the additional status and approval columns show. See How is resource planning done with the Negotiations feature enabled? for more information about the notifications & approvals with negotiations. " }, 
...
"body" : "Introduction " }, 
{ "title" : "Define the Planning Units Modes ", 
...
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ Resource Plans \/ Resource Planning Units Mode \/ Define the Planning Units Modes ", 
"snippet" : "...", 
"body" : "" }, 
...
"snippet" : "By default, when the Candidates List is shown, the current plan's resources will show. Details about the resources show in the columns on the left side. The resources' allocation broken down by plan will show on the right. The summary row shows the remaining availability. Resource Plan Color Legend ...", 
"body" : "By default, when the Candidates List is shown, the current plan's resources will show. Details about the resources show in the columns on the left side. The resources' allocation broken down by plan will show on the right. The summary row shows the remaining availability. Resource Plan Color Legend GREEN: Less than 90% Availability Used LIGHT GREEN: Greater than or Equal to 90% --- to --- Less than or Equal to 100% Availability Used YELLOW: Greater than 100% --- to --- Less than or Equal to 105% Availability Used ORANGE: Greater than 105% --- to --- Less than 112% Availability Used RED: Greater than or Equal to 112% Availability Used Expand any resource to see to which plans they are allocated. If the private\/public feature is enabled, only public rows will be included in the totals. " }, 
...
"snippet" : "...", 
"body" : "" }, 
{ "title" : "Planning Units Mode ", 
"url" : "using-oneplan/oneplan-in-other-apps/planning-units-mode.html", 
"breadcrumbs" : "Use OnePlan \/ Using OnePlan \/ OnePlan in Other Apps \/ Planning Units Mode ", 
"snippet" : "...", 
"body" : "" }, 
