...
"snippet" : "This article provides an introduction to the OnePlan Modeler app. To enable it, your adminisrator will need to install the \"Modeler\" app. The new portfolio Modeler allows for advanced top down strategic portfolio planning. The Modeler allows you to: Create multiple models and scenarios to map out po...", 
"body" : "This article provides an introduction to the OnePlan Modeler app. To enable it, your adminisrator will need to install the \"Modeler\" app. The new portfolio Modeler allows for advanced top down strategic portfolio planning. The Modeler allows you to: Create multiple models and scenarios to map out possible ways to meet your goals within set budgets. See Create a Model Scenario and Create a Modeler Model. Organize multiple models into folders. See Create a Modeler Folder. You can then compare scenarios to find the optimal plan. See Compare Scenarios. Multiple people can create their own models using the plans and constraints they pick. Each model can contain one or more what if scenarios. You can then share the models with other people to view and collaborate. See Create a Model Scenario and Create a Modeler Model. Analyze your various scenarios using OnePlan's powerful project management tools. See Additional Modeler View Options. " }, 
{ "title" : "View Reports and Dashboards ", 
